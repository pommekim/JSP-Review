...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%
    	...
    	*/
    	...
    	//Object타입으로 리턴되는 값을 String타입으로 다시 끌어내려야 함
    	...
    	//세션의 유효시간 설정.
    	session.setMaxInactiveInterval(60 * 60); //초 단위 시간 설정. (지정하지 않으면 기본은 30분)
    	...
    	//모든 세션 데이터를 삭제. (보통 로그아웃할 때나 탈퇴할 때 많이 사용!!!)
    	session.invalidate();
    	
    	//isRequestedSessionIdValid(): 현재 페이지에서 유효한 세션 데이터가 존재하는지를 확인하는 메서드.
