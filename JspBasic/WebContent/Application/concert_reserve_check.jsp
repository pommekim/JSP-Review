...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%
        ...
        */
        ...
        //예매 희망 좌석이 확정 좌석과 한번도 겹치지 않은 경우.
        if(count == seat.length) list.addAll(temp);
...
<body>
	...
	<div align="center">
		...
		<p>
			<%--
			- 선택한 좌석이 어디인지 브라우저에 출력해 주세요.
			ex) 선택한 좌석: [A-1, A-2, A-3...]
			
			- 예매 신청 결과를 출력해 주세요. (성공/실패)
			- 추가 예매를 할 수 있는 링크를 제공하세요. (concert_reserve.jsp)
			 --%>
